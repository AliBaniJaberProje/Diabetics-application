...
Color getColorForThisFruteBorder(String foodName) {
  switch (foodName) {
    case "ريحان":
      return Colors.green;
    case "كزبرة":
...
Color getColorForThisFrute(String foodName) {
  switch (foodName) {
    case "ريحان":
      ...
      for (int i = 0; i < resultResponse.length; i++) {
        foodList.add(
          new FoodItem2(
              ...
              color:
                  getColorForThisFrute(resultResponse[i]['name'].toString()),
              borderColor: getColorForThisFruteBorder(
