...
class _FoodDetailsState extends State<FoodDetails> {
  ...
  @override
  void initState() {
    context.read<FoodDetailsProvider>().sendRequestToGetDetails(widget.foodInfo.id);
    super.initState();
  }
          ...
          slivers: <Widget>[
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                title: Container(
                  ...
                  child: Text("${widget.foodInfo.name}",style: TextStyle(fontWeight: FontWeight.w200,fontSize: 25),textAlign: TextAlign.center,),
                ),
                background: Hero(
            ...
            SliverToBoxAdapter(
              child: Container(child:Card(
                ...
                child: Text(title,textAlign: TextAlign.center,style: TextStyle(fontSize: 18,fontWeight: FontWeight.w100),),),
              ) ),


            SliverToBoxAdapter(
              child: Container(child: AnimationLimiter(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text("${foodDetailsProviderWatch.component[index].unit.padLeft(10, " ")}",style: TextStyle(fontSize: 18),textAlign: TextAlign.start,),
                                      SizedBox(width: 60,),
                                      Text("${foodDetailsProviderWatch.component[index].value.padLeft(10, " ")}",style: TextStyle(fontSize: 18),textAlign: TextAlign.start,),
                                      SizedBox(width: 60,),
                                      Text("${foodDetailsProviderWatch.component[index].nameFoodItem.padLeft(20, " ")}",style: TextStyle(fontSize: 18),textAlign: TextAlign.start,),
                                    ],
                                  ),
                                  SizedBox(width: 20,),
                                  IdDoseContainer("${index+1}",widget.foodInfo.borderColor.withOpacity(.4),20),
                                ],
